...
-   	16 rue de Chatillon 91260 JUVISY SUR ORGE
-   	0760292363
-   	gore.goli@gmail.com
...
La commande de Produits est réservée aux Clients justifiant obligatoirement d'une adresse de livraison en France métropolitaine, [Liste des pays et territoires concernés], de format et standard français (nom, prénom, adresse postale, code postal, ville, pays).
...
-                  une somme correspondant à 0 % du prix total hors taxes des Produits sera due au Vendeur et facturée au Client.
...
[SI vente à exécution successive (ex : abonnement)]
...
En cas de retour de Produits salis par le Client, le Vendeur facturera au Client une somme forfaitaire de 500 euros au titre du nettoyage.
 
En cas de retour de Produits descellés nécessitant un reconditionnement et/ou une réinitialisation du fait de leur utilisation par le Client, le Vendeur facturera au Client une somme forfaitaire de 500 euros.
 
Le retour s’effectue aux risques et sous l’entière responsabilité du Client, lequel est libre de choisir le mode d'envoi des Produits et de souscrire ou non une assurance en cas de perte, de vol ou de destruction de son colis. Le retour de Produits en port dû n’est pas accepté. Si l’emballage d’origine du Produit est utilisé comme carton pour l’expédition du retour, le Vendeur facturera au Client une somme forfaitaire de 30 euros.
...
[Si une garantie commerciale ou des prestations de service après-vente sont prévues]
...
9.2 Garantie légale de conformité (Extraits Code de la Consommation)
...
[S’il existe des transferts de données à caractère personnel vers un pays hors UE]
Les données à caractère personnel sont susceptibles d’être transférées vers des pays situés hors de l’Union Européenne (tels que [Nom des pays destinataires des transferts de données à caractère personnel]) dans le but de [Finalité des transferts effectués].
...
[S’il existe des transferts vers les Etats-Unis]
...
Le Client est informé qu’il est libre de recourir gratuitement à un médiateur de la consommation en vue de la résolution amiable d’un litige qui l’opposerait au Vendeur, conformément aux articles L.611-1  et suivants et R.612-1 et suivants du Code de la Consommation.  Le(s) médiateur(s) de la consommation dont relève le Vendeur est/sont le(s) suivant(s) : GOLI Gore Gbaka/16 rue de chatillon 91260 JUVISY SUR ORGE/gore.goli@gmail.com/https://www.dessinsgore.fr
 
Tous les litiges auxquels les Conditions Générales pourraient donner lieu, concernant tant leur validité, interprétation, exécution, résiliation, leurs conséquences et leurs suites, seront soumis au tribunal de EVRY.
...
--------------------------------------------------------------------------------------------------------------
À l’attention de:  Monsieur GOLI Gore Gbaka
16 rue de Chatillon 91260 JUVISY SUR ORGE
